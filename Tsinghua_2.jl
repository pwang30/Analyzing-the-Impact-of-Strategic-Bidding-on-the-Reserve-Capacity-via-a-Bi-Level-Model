...
@variable(Upper(model), lambda_1<=k_max*b_MT[1], DualOf(power_balance[1]))
@variable(Upper(model), lambda_2<=k_max*b_MT[1], DualOf(power_balance[2]))
@variable(Upper(model), lambda_3<=k_max*b_MT[1], DualOf(power_balance[3]))
@variable(Upper(model), lambda_4<=k_max*b_MT[1], DualOf(power_balance[4]))
@variable(Upper(model), lambda_5<=k_max*b_MT[1], DualOf(power_balance[5]))
@variable(Upper(model), lambda_6<=k_max*b_MT[1], DualOf(power_balance[6]))
@variable(Upper(model), lambda_7<=k_max*b_MT[1], DualOf(power_balance[7]))
@variable(Upper(model), lambda_8<=k_max*b_MT[1], DualOf(power_balance[8]))
@variable(Upper(model), lambda_9<=k_max*b_MT[1], DualOf(power_balance[9]))
@variable(Upper(model), lambda_10<=k_max*b_MT[1], DualOf(power_balance[10]))
@variable(Upper(model), lambda_11<=k_max*b_MT[1], DualOf(power_balance[11]))
@variable(Upper(model), lambda_12<=k_max*b_MT[1], DualOf(power_balance[12]))
@variable(Upper(model), lambda_13<=k_max*b_MT[1], DualOf(power_balance[13]))
@variable(Upper(model), lambda_14<=k_max*b_MT[1], DualOf(power_balance[14]))
@variable(Upper(model), lambda_15<=k_max*b_MT[1], DualOf(power_balance[15]))
@variable(Upper(model), lambda_16<=k_max*b_MT[1], DualOf(power_balance[16]))
@variable(Upper(model), lambda_17<=k_max*b_MT[1], DualOf(power_balance[17]))
@variable(Upper(model), lambda_18<=k_max*b_MT[1], DualOf(power_balance[18]))
@variable(Upper(model), lambda_19<=k_max*b_MT[1], DualOf(power_balance[19]))
@variable(Upper(model), lambda_20<=k_max*b_MT[1], DualOf(power_balance[20]))
@variable(Upper(model), lambda_21<=k_max*b_MT[1], DualOf(power_balance[21]))
@variable(Upper(model), lambda_22<=k_max*b_MT[1], DualOf(power_balance[22]))
@variable(Upper(model), lambda_23<=k_max*b_MT[1], DualOf(power_balance[23]))
@variable(Upper(model), lambda_24<=k_max*b_MT[1], DualOf(power_balance[24]))


rev_comp_1=lambda_1*P_MT_1[1] +lambda_2*P_MT_1[2] +lambda_3*P_MT_1[3] +lambda_4*P_MT_1[4] +lambda_5*P_MT_1[5] +lambda_6*P_MT_1[6] +lambda_7*P_MT_1[7] +lambda_8*P_MT_1[8] +lambda_9*P_MT_1[9] +lambda_10*P_MT_1[10] + 
lambda_11*P_MT_1[11] +lambda_12*P_MT_1[12] +lambda_13*P_MT_1[13] +lambda_14*P_MT_1[14] +lambda_15*P_MT_1[15] +lambda_16*P_MT_1[16] +lambda_17*P_MT_1[17] +lambda_18*P_MT_1[18] +lambda_19*P_MT_1[19] +lambda_20*P_MT_1[20] +
lambda_21*P_MT_1[21] +lambda_22*P_MT_1[22] +lambda_23*P_MT_1[23] +lambda_24*P_MT_1[24]

@objective(Upper(model), Max, rev_comp_1 -(b_MT[1]*sum(P_MT_1)+ λ_BS[1]*sum(P_BS_1.*P_BS_1)) )



C_2=b_MT[2]*sum(P_MT_2)+ λ_BS[2]*sum(P_BS_2.*P_BS_2)
C_1=sum(k.*P_MT_1*b_MT[1])+ λ_BS[1]*sum(P_BS_1.*P_BS_1)
...
#---------------------------Output the results-------------------
rev_comp_1=JuMP.value.(rev_comp_1)
rev_comp_2=sum(clearing_price.*P_MT_2)
...
matwrite("bidding_comp_1.mat", Dict("bidding_comp_1" => k))

matwrite("reserve_total_comp_1.mat", Dict("reserve_total_comp_1" => reserve_total))
matwrite("reserve_cons_comp_1.mat", Dict("reserve_cons_comp_1" => reserve_cons))

matwrite("reserve_I_comp1_comp_1.mat", Dict("reserve_I_comp1_comp_1" => reserve_1))
matwrite("reserve_I_comp2_comp_1.mat", Dict("reserve_I_comp2_comp_1" => reserve_2))
matwrite("reserve_I_comp3_comp_1.mat", Dict("reserve_I_comp3_comp_1" => reserve_3))

matwrite("reserve_II_comp1_comp_1.mat", Dict("reserve_II_comp1_comp_1" => reserve_1_cons))
matwrite("reserve_II_comp2_comp_1.mat", Dict("reserve_II_comp2_comp_1" => reserve_2_cons))
matwrite("reserve_II_comp3_comp_1.mat", Dict("reserve_II_comp3_comp_1" => reserve_3_cons))


matwrite("clearing_price_comp_1.mat", Dict("clearing_price_comp_1" => clearing_price))

matwrite("load.mat", Dict("load" => load))
matwrite("P_Wmax_1.mat", Dict("P_Wmax_1" => P_Wmax_1))
matwrite("P_Wmax_2.mat", Dict("P_Wmax_2" => P_Wmax_2))
matwrite("P_Wmax_3.mat", Dict("P_Wmax_3" => P_Wmax_3))
