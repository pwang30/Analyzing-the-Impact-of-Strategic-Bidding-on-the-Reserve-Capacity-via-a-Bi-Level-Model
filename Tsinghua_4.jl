...
@variable(Upper(model), lambda_1<=k_max*b_MT[3], DualOf(power_balance[1]))
@variable(Upper(model), lambda_2<=k_max*b_MT[3], DualOf(power_balance[2]))
@variable(Upper(model), lambda_3<=k_max*b_MT[3], DualOf(power_balance[3]))
@variable(Upper(model), lambda_4<=k_max*b_MT[3], DualOf(power_balance[4]))
@variable(Upper(model), lambda_5<=k_max*b_MT[3], DualOf(power_balance[5]))
@variable(Upper(model), lambda_6<=k_max*b_MT[3], DualOf(power_balance[6]))
@variable(Upper(model), lambda_7<=k_max*b_MT[3], DualOf(power_balance[7]))
@variable(Upper(model), lambda_8<=k_max*b_MT[3], DualOf(power_balance[8]))
@variable(Upper(model), lambda_9<=k_max*b_MT[3], DualOf(power_balance[9]))
@variable(Upper(model), lambda_10<=k_max*b_MT[3], DualOf(power_balance[10]))
@variable(Upper(model), lambda_11<=k_max*b_MT[3], DualOf(power_balance[11]))
@variable(Upper(model), lambda_12<=k_max*b_MT[3], DualOf(power_balance[12]))
@variable(Upper(model), lambda_13<=k_max*b_MT[3], DualOf(power_balance[13]))
@variable(Upper(model), lambda_14<=k_max*b_MT[3], DualOf(power_balance[14]))
@variable(Upper(model), lambda_15<=k_max*b_MT[3], DualOf(power_balance[15]))
@variable(Upper(model), lambda_16<=k_max*b_MT[3], DualOf(power_balance[16]))
@variable(Upper(model), lambda_17<=k_max*b_MT[3], DualOf(power_balance[17]))
@variable(Upper(model), lambda_18<=k_max*b_MT[3], DualOf(power_balance[18]))
@variable(Upper(model), lambda_19<=k_max*b_MT[3], DualOf(power_balance[19]))
@variable(Upper(model), lambda_20<=k_max*b_MT[3], DualOf(power_balance[20]))
@variable(Upper(model), lambda_21<=k_max*b_MT[3], DualOf(power_balance[21]))
@variable(Upper(model), lambda_22<=k_max*b_MT[3], DualOf(power_balance[22]))
@variable(Upper(model), lambda_23<=k_max*b_MT[3], DualOf(power_balance[23]))
@variable(Upper(model), lambda_24<=k_max*b_MT[3], DualOf(power_balance[24]))


rev_comp_3=lambda_1*P_MT_3[1] +lambda_2*P_MT_3[2] + lambda_3*P_MT_3[3] + lambda_4*P_MT_3[4] +
lambda_5*P_MT_3[5] + lambda_6*P_MT_3[6] + lambda_7*P_MT_3[7] + lambda_8*P_MT_3[8] +
lambda_9*P_MT_3[9] + lambda_10*P_MT_3[10] + lambda_11*P_MT_3[11] + lambda_12*P_MT_3[12] +
lambda_13*P_MT_3[13] + lambda_14*P_MT_3[14] + lambda_15*P_MT_3[15] + lambda_16*P_MT_3[16] +
lambda_17*P_MT_3[17] + lambda_18*P_MT_3[18] + lambda_19*P_MT_3[19] + lambda_20*P_MT_3[20] +
lambda_21*P_MT_3[21] + lambda_22*P_MT_3[22] + lambda_23*P_MT_3[23] + lambda_24*P_MT_3[24]

@objective(Upper(model), Max, rev_comp_3 -(b_MT[3]*sum(P_MT_3)+ λ_BS[3]*sum(P_BS_3.*P_BS_3)) )



C_1=b_MT[1]*sum(P_MT_1)+ λ_BS[1]*sum(P_BS_1.*P_BS_1)
C_3=sum(k.*P_MT_3*b_MT[3])+ λ_BS[3]*sum(P_BS_3.*P_BS_3)
...
#---------------------------Output the results-------------------
rev_comp_3=JuMP.value.(rev_comp_3)
...
matwrite("bidding_comp_3.mat", Dict("bidding_comp_3" => k))

matwrite("reserve_total_comp_3.mat", Dict("reserve_total_comp_3" => reserve_total))
matwrite("reserve_cons_comp_3.mat", Dict("reserve_cons_comp_3" => reserve_cons))

matwrite("reserve_I_comp1_comp_3.mat", Dict("reserve_I_comp1_comp_3" => reserve_1))
matwrite("reserve_I_comp2_comp_3.mat", Dict("reserve_I_comp2_comp_3" => reserve_2))
matwrite("reserve_I_comp3_comp_3.mat", Dict("reserve_I_comp3_comp_3" => reserve_3))

matwrite("reserve_II_comp1_comp_3.mat", Dict("reserve_II_comp1_comp_3" => reserve_1_cons))
matwrite("reserve_II_comp2_comp_3.mat", Dict("reserve_II_comp2_comp_3" => reserve_2_cons))
matwrite("reserve_II_comp3_comp_3.mat", Dict("reserve_II_comp3_comp_3" => reserve_3_cons))


matwrite("clearing_price_comp_3.mat", Dict("clearing_price_comp_3" => clearing_price))